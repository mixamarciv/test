...
(function($) {
    function TwoDimSlider(d, f) {
        ...
        self._mn4.bind('click', function() {
            console.log("self._mn4.bind('click'");
            self._ev5()
        });
    ...
    TwoDimSlider.prototype = {
                ...
                if (hasVideo) {
                    ...
                    if (!blockInside.find('.play-button-container').length > 0) {
                        ...
                        blockInside.find('.play-button-container').bind('click', function(e) {
                            console.log("blockInside.find('.play-button-container').bind('click'");
                            if (!c.moved) {
                                e.preventDefault();
                                e.stopImmediatePropagation();
                                c._ir3 = true;
        ...
        _by2: function() {
            if (!this.hasTouch) {
                console.log('_by2: function()  !this.hasTouch');
                if (this._mn1) {
            ...
            if (!b._ir4) {
                if (b._dw5.data('curr-album-id') !== b.currAlbumId) {
                    ...
                    j.bind('click', function(e) {
                        console.log("j.bind('click'  b._cx8() ");
                        e.preventDefault();
                        b._cx8()
                    });
                    b._dw5.find('.pin-it-btn, .facebook-share-btn').click(function(e) {
                        console.log("b._dw5.find('.pin-it-btn, .facebook-share-btn').click(");
                        e.preventDefault();
