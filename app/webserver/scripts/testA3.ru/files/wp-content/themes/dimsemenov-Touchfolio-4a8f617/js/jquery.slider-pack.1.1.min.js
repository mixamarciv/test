...
(function($) {
    ...
    TwoDimSlider.prototype = {
        ...
        _by8: function(b, c, d, e, f, g) {
            ...
            if (!h._ev1) {
                i[moveProp] = b;
                h._jq2.animate(i, h._jq, f ? h.settings.easeInOutEasing : 'easeOut')
            } else {
        ...
        _dw8: function(a, b) {
            ...
            c.currAlbumId = a;
            if(c.currAlbumId!=c._2prevAlbumId) c._cx8();
            var d = c.albumsArr[a];
            if (d) {
                var e = d.find('.two-dim-item');
                if (e) {
        ...
        _irn8: function(b) {
            ...
            return function() {
                ...
                if (hasVideo) {
                    blockInside.find('.play-button-container').unbind('click').remove();
        ...
        _mn6: function() {
            ...
            if (b.currItemId==0 || !b._ir4){
                ...
                if (b._dw5.data('curr-album-id') !== b.currAlbumId) {
                    ...
                    var d = '<div class="info-container" style="padding-bottom:50px;">' + c.html();
                    ...
                    d += '</div>';
                    b._dw5.html(d);
                    //b._dw5.css('border','5px solid #f00');
