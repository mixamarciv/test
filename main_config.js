...
//c.app_name = 'webc4';
c.main_app_path  = path_norm(__dirname);                         //путь к приложению

c.temp_path      = path_join(c.main_app_path,'temp');            //пути к временным файлам (файлы которые пере/создаются при перезапуске приложения)
